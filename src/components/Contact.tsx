export default function Contact() {
  return (
    <section id="contact" className="relative z-[1] py-24 px-12 max-w-[800px] mx-auto text-center">
      ...
      <p className="text-text-muted text-[17px] mb-12 leading-[1.7]">
        Open to junior analyst roles, internships, and freelance data projects.<br />
      ...
      <div className="flex justify-center gap-4 flex-wrap mb-16">
        ...
        >
          <span>✉</span> alex.morgan@email.com
        </a>
